...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [ 
                "You are in the room with trampolines",
                "You are in the room with a ball pit",
                "You are in the room full of kittens",
                "You are in the room with anime posters plastering the walls",
        ][room_number]
